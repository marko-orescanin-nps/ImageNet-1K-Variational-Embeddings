...
ITERATIONS = 10
MC_SAMPLES = 20
pickle_save_path = f'/data/kraken/coastal_project/coastal_proj_code/orange_cable/vi_flipout/vi_flipout_cable_{ITERATIONS}_{MC_SAMPLES}.pickle'
...
test_data = tf.keras.utils.image_dataset_from_directory(
    '/data/kraken/coastal_project/coastal_proj_code/orange_cable_pics_resized',
